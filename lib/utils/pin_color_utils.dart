...
class PinColorUtils {
  static Color pinColor(
    ...
    // 🔵 Blue — reading saved locally, not yet uploaded
    if (hasPendingReading) return const Color(0xFF3182CE);

    // 🟢 Green — reading confirmed on server this week
    final readings = plant['readings'] as List?;
    if (_hasReadingThisWeek(readings)) return const Color(0xFF38A169);

    // ⚫ Gray — no reading yet this week
